	...
	{	
		...
		try
		{
			...
			else if (frame.equals("2"))
			{
				...
				//Toast.makeText(MainActivity.this, "游戏帧率：中", Toast.LENGTH_SHORT).show();
			}
			...
			else if (ui_resolution.equals("1"))
			{
				...
				//Toast.makeText(MainActivity.this, "界面分辨率:低", Toast.LENGTH_SHORT).show();
			}
			else if (ui_resolution.equals("2"))
			{
				...
				//Toast.makeText(MainActivity.this, "界面分辨率:中", Toast.LENGTH_SHORT).show();
			}
			else if (ui_resolution.equals("3"))
			{
				...
				//Toast.makeText(MainActivity.this, "界面分辨率:高", Toast.LENGTH_SHORT).show();
			}
